...
First we group the step numbers by the date using group_by and take the sum of the total steps on each day. We then use this to calculate the mean and median steps of each day. For this dataset the mean of the total steps for each day was 'r mean_steps' and the median was 'r median_steps'
