...
This dataset had a total of `r total_nas` missing values. I chose to impute this missing data by replacing them with the average step number at the respective interval. To accomplish this, I grouped the dataset by its interval across all dates and took the mean of the steps at each interval. I then used a for loop to look through the steps column for missing values. When a missing value is found, it is replaced with the average value at the corresponding interval.
